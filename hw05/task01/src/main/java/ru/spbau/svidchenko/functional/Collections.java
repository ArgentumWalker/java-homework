...
public final class Collections {
    ...
    static public <T, U> Collection<U> map(Function1<T, U> f, Collection<T> a) {
    ...
    static public <T> Collection<T> filter(Predicate<T> p, Collection<T> a) {
    ...
    static public <T> Collection<T> takeWhile(Predicate<T> p, Collection<T> a) {
        LinkedList<T> result = new LinkedList<T>();
        for (T elem : a) {
            if (p.apply(elem)) {
                result.addLast(elem);
    ...
    static public <T> Collection<T> takeUnless(Predicate<T> p, Collection<T> a) {
        return takeWhile(p.not(), a);
    }
    /** See Haskell::foldr */
    static public <T, U> U foldr(Function2<T, U, U> f, U init,  Collection<T> a) {
    ...
    /** See Haskell::foldl */
    static public <T, U> U foldl(Function2<T, U, U> f, U init, Collection<T> a) {
        U result = init;
        for (T elem : a) {
